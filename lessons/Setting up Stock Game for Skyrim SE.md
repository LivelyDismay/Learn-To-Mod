...
To setup Wrye Bash, an addition argument must be passed to the executable. This argument is `-o "C:\\Path\\To\\Folder\\Game Root\\"`, making sure to use double blackslashes, like so:

![alt text](https://github.com/LivelyDismay/Learn-To-Mod/blob/main/images/Stock%20Game%2014.png)

To make sure it workes, you should launch Wrye Bash, and it should take you directly into its main screen. If Wrye Bash goes into a screen that asks you to choose a game to manage, you got the path wrong.
